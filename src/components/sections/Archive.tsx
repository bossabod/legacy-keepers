            ...
            {ARCHIVE_YEARS.map((y) => {
              ...
              return (
                <button
                  ...
                  style={{
                    fontFamily: MONO,
                    borderColor: on ? "rgba(143,160,184,0.45)" : "rgba(255,255,255,0.05)",
                    background: on ? "rgba(143,160,184,0.10)" : "transparent",
                  }}
                >
                  <span
                    className="text-[0.86rem] tracking-wider transition-colors"
                    style={{ color: on ? "#eaeef5" : "#7a8291", textShadow: on ? "0 0 14px rgba(143,160,184,0.5)" : "none" }}
                  >
                    {y}
                  </span>
                  <span
                    ...
                    style={{
                      borderColor: on ? "rgba(143,160,184,0.35)" : "rgba(255,255,255,0.08)",
                        ...
                        >
                          <span className="flex min-w-0 items-center gap-2.5">
                            <span
                              ...
                              style={{ borderColor: "rgba(143,160,184,0.25)", background: "rgba(143,160,184,0.07)" }}
                            >
                        ...
                        >
                          ...
                          <div className="mt-2.5 flex flex-wrap items-center gap-2 border-t border-white/[0.05] pt-2.5">
                            <span
                              ...
                              style={{ borderColor: "rgba(143,160,184,0.25)", color: "#a9b2c0" }}
                            >
                              {ar ? f.rec.gradeAr : f.rec.gradeEn}
                            </span>
                            <span
