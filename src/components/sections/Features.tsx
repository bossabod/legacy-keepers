...
const inputClass = "w-full bg-[#050609]/85 border border-[#383f4d]/80 focus:border-[#b0b0b0]/60 rounded-xl px-4 py-3 text-[#eaeef5] text-sm outline-none transition-all duration-300 shadow-[inset_0_2px_6px_rgba(0,0,0,0.8)] focus:bg-[#07090f] font-sans";
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {SERVICES.map((s, i) => (
          <Reveal key={s.id} delay={(i % 4) * 0.05}>
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-[#b0b0b0]/20 bg-[#b0b0b0]/5 transition-all duration-300 group-hover:border-[#b0b0b0]/40 group-hover:bg-[#b0b0b0]/10">
          ...
          <div className="glass-strong relative z-10 w-full max-w-lg rounded-2xl p-8 shadow-[0_30px_80px_rgba(0,0,0,0.9)] max-h-[90vh] overflow-y-auto">
            ...
            {status === "done" ? (
              <div className="flex flex-col items-center gap-4 py-10 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full border border-[#b0b0b0]/30 bg-gradient-to-b from-[#1e2430] to-[#0a0d12] shadow-[0_0_30px_rgba(176,176,176,0.15)]">
                  <Check size={28} className="text-[#b0b0b0]" />
                </div>
              ...
              <>
                <div className="mb-6 flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#b0b0b0]/20 bg-[#b0b0b0]/5">
                    <active.icon size={20} className="text-[#b0b0b0]" />
                  </div>
                  <div>
                  ...
                  <button type="submit" disabled={status === "submitting"} onMouseEnter={() => play("hover")} className="w-full rounded-xl border border-[#b0b0b0]/30 bg-gradient-to-b from-[#2a313d] to-[#0a0d13] py-4 text-sm font-semibold uppercase tracking-[0.18em] text-[#eaeef5] transition-all duration-300 hover:border-[#b0b0b0]/50 hover:text-white disabled:opacity-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_10px_30px_rgba(0,0,0,0.6)]" style={{ fontFamily: "var(--font-luxury)" }}>
                    {status === "submitting" ? (
                      <span className="flex items-center justify-center gap-2.5 mono text-xs tracking-widest">
                        <Loader2 className="animate-spin text-[#b0b0b0]" size={16} /> PROCESSING...
                      </span>
                    ) : "Submit Request"}
                  </button>
                </form>
