    ...
    if (this.state.hasError) {
      return (
        <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#050505] px-6 text-center">
          <div className="text-[0.6rem] uppercase tracking-[0.3em] text-[#8a6b1f]" style={{ fontFamily: "var(--font-ibm-mono)" }}>
            Owners of Impact
          </div>
          ...
          <button
            ...
            className="mt-2 rounded-md border border-[#c9a227]/30 bg-transparent px-6 py-2.5 text-[0.7rem] uppercase tracking-[0.2em] text-[#e8c547] transition hover:border-[#c9a227]/60"
          >
            Return to Gateway
          </button>
        </div>
