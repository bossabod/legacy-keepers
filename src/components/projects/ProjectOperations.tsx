...
/* =====================================================================
   Project Operations — the full operational page, moved as-is from HOME.
   Contains: interactive map (Global Command Globe), member identity,
   Annual/Operational performance dashboard, Project Status, Monthly
   Growth, Estimated Spend/Timeline, Quick glance, World clocks, and the
   Projects dashboard (digital & physical). Nothing removed or rebuilt.
   ===================================================================== */
...
export default function ProjectOperations({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-12">
      {/* ═══════ Global Command Globe — interactive map (moved from HOME) ═══════ */}
      <Reveal>
        <div
      ...
      {/* ═══════ Operational Performance Dashboard (moved from HOME) ═══════ */}
      <Reveal delay={0.05}>
      ...
      {/* ═══════ Quick glance + World clocks (moved from HOME) ═══════ */}
      ...
      {/* ═══════ Projects dashboard — status, growth, timeline, digital & physical ═══════ */}
