    ...
    >
      ...
      <header className="relative z-40 flex items-center justify-between px-6 py-6 sm:px-12 lg:px-16 w-full pointer-events-auto">
        <button
          ...
          className="group inline-flex items-center gap-2 rounded-lg px-3.5 py-1.5 text-xs font-mono tracking-widest text-[#8b95a5] border border-white/[0.08] bg-black/40 backdrop-blur-md transition-all duration-300 hover:border-[#8fb4d8]/40 hover:text-[#eaeef5] hover:bg-white/[0.04] cursor-pointer"
        >
      ...
      <main className="relative z-40 flex-1 flex items-center justify-center px-4 sm:px-8 py-10 pointer-events-auto">
        <motion.div
          ...
          className="relative z-40 w-full max-w-md rounded-2xl p-8 sm:p-10 backdrop-blur-2xl bg-gradient-to-b from-[#0e1118]/90 via-[#080a0e]/92 to-[#040507]/95 border border-[#8fb4d8]/20 shadow-[0_30px_70px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.08)] overflow-hidden pointer-events-auto"
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="h-1.5 w-1.5 rounded-full bg-[#8fb4d8] shadow-[0_0_8px_#8fb4d8]" />
          </div>
          ...
          >
            ...
            <div className="pt-3">
              <button
                ...
                style={{
                  background: "linear-gradient(180deg, #1a2a3d 0%, #0f1824 50%, #080e18 100%)",
              ...
              >
                ...
                {verifying ? (
                  <span className="flex items-center justify-center gap-2.5 font-mono text-xs tracking-widest">
                    <Loader2 className="animate-spin text-[#8fb4d8]" size={16} />
                    AUTHENTICATING...
                  </span>
                ) : (
          ...
          <div className="mt-4">
            <button
              ...
              className="w-full rounded-md border border-white/[0.08] bg-black/30 px-3 py-2.5 text-center transition-all duration-300 hover:border-[#8fb4d8]/35 hover:bg-white/[0.04] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer pointer-events-auto"
            >
          ...
          >
            <div className="relative h-16 w-16">
              <div
                ...
                style={{ borderTopColor: "#8fb4d8" }}
              />
              <Lock className="absolute inset-0 m-auto text-[#8fb4d8]" size={20} />
            </div>
